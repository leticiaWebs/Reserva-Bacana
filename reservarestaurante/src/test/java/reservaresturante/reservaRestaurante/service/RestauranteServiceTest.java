...
public class RestauranteServiceTest {
    ...
    @Test
    public void testFindByTipoCozinhaNotFound() {
        when(restauranteRepository.findByTipoCozinha(TipoCozinha.ITALIANA)).thenReturn(Arrays.asList());

        Exception exception = assertThrows(ResourceNotFoundException.class, () -> {
            restauranteService.findByTipoCozinha(TipoCozinha.ITALIANA);
        });

        assertEquals("Nenhum restaurante encontrado com a cozinha: ITALIANA", exception.getMessage());
    }
